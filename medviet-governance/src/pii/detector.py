...
def build_vietnamese_analyzer() -> AnalyzerEngine:
    ...
    person_pattern = Pattern(name="vn_person", regex=r"[A-ZÀ-Ỹ][a-zà-ỹ]+(?: [A-ZÀ-Ỹ][a-zà-ỹ]+)+", score=1.0)
    person_recognizer = PatternRecognizer(supported_entity="PERSON", patterns=[person_pattern], supported_language="vi")

    # --- TASK 2.2.3 ---
    # Tạo NLP engine dùng spaCy Vietnamese model (using en_core_web_sm as fallback since spacy doesn't have vi_core_news_lg by default)
